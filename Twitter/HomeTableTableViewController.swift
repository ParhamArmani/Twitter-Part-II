...
class HomeTableTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let temp_time = tweetArray[indexPath.row]["created_at"]as! String
        let lowerBound = String.Index(encodedOffset: 4)
        let upperBound = String.Index(encodedOffset: 19)
        let mySubstring = temp_time[lowerBound..<upperBound]
        cell.timeLabel.text = String(mySubstring)
...
//        cell.setFavorite((tweetArray[indexPath.row]["favorited"] != nil)) as! Bool
